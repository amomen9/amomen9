\textbf{Portfolio --- Ali Momen}

\textbf{Name:} Ali Momen

\textbf{Email:}
\href{mailto:amomen@gmail.com}{\nolinkurl{amomen@gmail.com}}

\textbf{Phone:} +31634397167

\textbf{Location:} Leiden, Netherlands

\textbf{Last Update:} 10/10/2025

\textbf{Current Occupation:} Just started Master's program in Data
Science and Artificial Intelligence at Leiden University

\textbf{Portfolio statement:} I combine a decade of production‑grade
database engineering and automation with teaching and applied analytics;
my work focuses on reliable data infrastructure, reproducible analysis,
and deployable analytics for high‑stakes domains.

\subsection{\texorpdfstring{Selected projects
}{Selected projects }}\label{selected-projects}

These projects were carried out for personal interests or from mostly
the last 2 job positions

\textbf{1. Automatic country‑wide branch downtime report --- Keshavarzi
Bank (Jan 2021)}

\textbf{Role:} Network engineer, (DBA \& data automation).

\textbf{Scope:} Nationwide report consolidating branch availability
metrics and automated alerting.

\textbf{Tools \& methods:} T‑SQL, R, scheduled jobs; reporting pipeline;
clustered SQL Server environment.

\textbf{Outcome / impact:}
...
country-wide (\url{https://en.wikipedia.org/wiki/Bank_Keshavarzi_Iran}).
The incidents also are relatively numerous due to various reasons
including power outage, unstable links, routers misconfigurations, and
poor maintenance services. Our team was composed of 12 members. Manual
...
\includegraphics[width=6.5in,height=2.54028in]{media/image1.png}

The part of the article that is allowed by the employer to be published
publicly is on the link below:

\url{https://github.com/amomen9/SQLServer-DBA-Tools/blob/main/Send\%20Formatted\%20Excel\%20File\%20with\%20Email/README.md}

\textbf{2. SQL Server cluster administration, legacy‑to‑modern
migrations, automation of dynamic database creation for every B2B
customer, designing a procedure for the complex task of multi-tenant
database migrations and new database creation --- JobVision \& HRCando
(Nov 2021 -- Nov 2023)}

\textbf{Role:} Senior Database, Data Developer \& Administrator; led
migrations and cross‑administration procedures

\textbf{Scope:} Plan and execute migrations from legacy systems to
modern DBMS; implement HA/cluster patterns and cross‑admin procedures.

\textbf{Tools \& methods:} SQL Server clustering, migration scripts,
CI/CD for DB deployments.
...
\includegraphics[width=6.5in,height=2.97778in]{media/image2.png}

\textbf{3. Automation \& monitoring across multi‑platform DB
environments --- Fanap Soft (Jun 2021 -- Nov 2021)}

\textbf{Role:} Database Administrator; automated processes via Bash and
T‑SQL; cross‑platform monitoring

\textbf{Scope:} Implement automated maintenance, monitoring dashboards,
and alerting across SQL Server, PostgreSQL, MySQL.

\textbf{Tools \& methods:} Bash automation, monitoring tools (Zabbix,
Red Gate, Grafana), T‑SQL jobs.

\textbf{Example of Automation Scripts:}
...
\begin{itemize}
\item
  \url{https://github.com/amomen9/PostgreSQL/blob/main/Backup/systemd\%20Backup\%20Automation/patroni.md}
\end{itemize}
...
\begin{itemize}
\item
  \url{https://github.com/amomen9/PostgreSQL/tree/main/Bash\%20Scripts/Index\%20Maintenance/Drop\%20Unused\%20Indexes}
\end{itemize}
...
\begin{itemize}
\item
  \url{https://github.com/amomen9/PostgreSQL/tree/main/Bash\%20Scripts/Index\%20Maintenance/Index\%20Rebuild/Reindex\%20User\%20Tables}
\end{itemize}
...
\begin{itemize}
\item
  \url{https://github.com/amomen9/MySQL-MariaDB/blob/main/Purge\%20Binary\%20Logs/Readme.md}
\end{itemize}

\textbf{Grafana Monitoring:}
...
\begin{quote}
Later, the Grafana dashboards used Prometheus as a data source to obtain
the collected measures scraped by Prometheus and visualize them with
various visuals, including time series visuals.
...
\item
  ...
  useful queries.
\item
  Keeping a base JSON as a \textbf{dashboard template} to further
  develop exclusive dashboards for various purpose PostgreSQL services
\end{itemize}
...
PostgreSQL exporter template dashboard which exists on the
\textbf{Grafana dashboards} website.

The JSON for this dashboard exists on the following link on my GitHub
PostgreSQL repository:

\url{https://github.com/amomen9/PostgreSQL/blob/main/Monitoring/Grafana/DBA\%20PostgreSQL\%20Exporter-1760555550358.json}
...
\includegraphics[width=6.41667in,height=3.82708in,alt={A screenshot of a computer AI-generated content may be incorrect.}]{media/image3.png}

\textbf{4. Network engineering and DB support --- Keshavarzi Bank (Mar
2020 -- Apr 2021)}

\textbf{Role:} Network engineer, database developer \& administrator;
managed SQL Server clusters and Cisco troubleshooting

\textbf{Scope:} Maintain mission‑critical systems, ensure high
availability and secure connectivity.

\textbf{Tools \& methods:} Cisco device troubleshooting, T‑SQL
analytics, cluster ops.
...
\textbf{5. International Students Office IT \& International
Communications Specialist --- Sharif University (Feb 2015)}

\textbf{Role \& scope:} Technical support and communication systems for
...
\href{https://web.archive.org/web/20230822163552/http:/iso.sharif.ir/en}{International
Students Office (ISO) - Sharif University of Technology}

\textbf{6. Teaching and mentoring --- Faratar az Danesh, Rouzbeh
Institute, Polytechnic High School, Mofid Securities (Sep
2011--present)}

\textbf{Role:} Instructor for RDBMS (PostgreSQL), Linux, DB
administration; high‑school mathematics and Olympiad coaching

\textbf{Scope \& methods:} Course design, hands‑on labs, mentoring DBA
teams.

\textbf{Outcome / impact:} Trained DBAs and students who moved to
production roles.

\begin{itemize}
\item
  \textbf{Course:} PostgreSQL for Database Developers and Administrators
  (FAD institute)

  \begin{itemize}
  \item
    Course link to syllabus:\\
    \url{https://fad.ir/Course/Details/145}
  \item
    Course contents (Session recordings \& slides):\\
    \href{https://1drv.ms/f/c/ef69c869ed815671/EkHasdImIwJHvihqEx0LEKYBWFfZs8gOn0HDN_hOMOa3ZQ?e=AnsKJd}{shared
    DOCs}
  \end{itemize}
\item
  \textbf{Course:} Advanced PostgreSQL for Database Administrators (FAD
  institute)

  \begin{itemize}
  \item
    Course link to syllabus:\\
    \url{https://fad.ir/Course/Details/146}
  \end{itemize}
\end{itemize}

Course Poster:

\includegraphics[width=5.71875in,height=3.07138in]{media/image4.png}

\begin{itemize}
\item
  Written document for PostgreSQL course on GitHub:\\
  \url{https://github.com/amomen9/PostgreSQL/tree/main/PostgreSQL\%20Course}
\item
  \textbf{Presentation:}
...
\textbf{Selected outputs and projects:}
...
\item
  ...
  \url{https://github.com/amomen9/PostgreSQL/tree/main/Useful\%20Scripts}
\item
  MSSQL backup and restore history report\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/Backup\%20\%26\%20Restore\%20History\%20Report}
\item
  MSSQL monitoring scripts\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/MonitorServer\%20(WhatIsActive)}
\item
  MSSQL Partitioning Information\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/Partitioning\%20View\%20Info}
\item
  MSSQL Permissions\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/Permissions}
\item
  RedGate Overall Waits for MSSQL\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/RedGate\%20Overall\%20Waits}
\item
  MSSQL Restore Latest Backups Using msdb and sys.master\_files\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/Restore\%20Latest\%20Backups}
\item
  MSSQL job info\\
  \url{https://github.com/amomen9/SQLServer-DBA-Tools/tree/main/sp_JobsInfo}\strut \\
  \includegraphics[width=6.5in,height=2.19028in]{media/image5.png}
\item
  PostgreSQL Patroni\\
  \url{https://github.com/amomen9/PostgreSQL/tree/main/Patroni}
\item
  PostgreSQL pgbouncer\\
  \url{https://github.com/amomen9/PostgreSQL/tree/main/PGBouncer}
\item
  PostgreSQL, a guide on how to upgrade the major version\\
  \url{https://github.com/amomen9/PostgreSQL/tree/main/PostgreSQL\%20Major\%20Version\%20Upgrade}
\item
  PostgreSQL, Resetting WAL segment sizes\\
  \url{https://github.com/amomen9/PostgreSQL/tree/main/Resetting\%20WAL\%20Segments'\%20Sizes\%20-\%20Doc}
\end{itemize}
...
\textbf{Programming \& data science:} Python; R; Stata; MATLAB; C/C++;
Java

\textbf{Databases \& tools:} Microsoft SQL Server (admin, clustering);
...
\textbf{Other:} Shell scripting (Bash), Windows Server, Cisco networks,
BI (SSAS/SSIS), PowerShell, API \& Web services,
containerization/orchestration, version control

\textbf{Languages:} Persian (native) C2; English (fluent) C1; German
(working) B1; French (basic) A2

\textbf{Portfolio appendix --- short CV}

Linkedin URL:

\url{https://www.linkedin.com/in/ali-momen}
...
\textbf{Education:} BSc Applied Mathematics, Sharif University of
Technology, 2006--2014; GPA 12.42 / 20

\textbf{Work experience (high level):}
...
\item
  JobVision \& HRCando --- Senior Database, Data Developer \&
  Administrator (Nov 2021 -- Nov 2023)
\item
...
\item
  FanamoozSanat \& HydraSanat‑Tadbir --- Full Stack Web Developer (May
  2007 -- Feb 2015)
\end{itemize}

\begin{quote}
\textbf{Certifications:} SQL Server administration; Microsoft BI
SSAS/SSIS; PowerShell; API \& Web Services; T‑SQL; others listed in CV

\textbf{References:} Parviz Aghasadeghi (CEO, Faratar az Danesh) ---
